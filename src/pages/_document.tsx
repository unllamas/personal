...
export default class Document extends NextDocument {
  render() {
    const schema = {
      ...
      jobTitle: 'Co-Founder and Product Engineer',
      worksFor: {
        '@type': 'Organization',
        name: 'Freelance',
      },
    ...
    return (
      <Html lang='es'>
        <Head>
          ...
          {/* Facebook */}
          <meta property='og:title' content='Jonathan Llamas | Co-Founder and Product Engineer' />
          ...
          {/* Twitter */}
          <meta name='twitter:title' content='Jonathan Llamas | Co-Founder and Product Engineer' />
